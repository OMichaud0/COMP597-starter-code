...
class TrainerStatsConfig(_BaseConfig):
    ...
    def __init__(self) -> None:
        ...
        self._arg_sample_interval_ms = _Arg(type=int, default=500, help="Sampling interval in milliseconds for resource collection.")
        self._arg_flush_every_n = _Arg(type=int, default=50, help="Flush step CSV every N written rows (<=0 disables periodic flush).")
